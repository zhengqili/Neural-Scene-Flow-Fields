...
def _load_data(basedir, start_frame, end_frame, 
    ...
    if ndc_depth:
        disp_dir = os.path.join(basedir, 'align_depth_ndc')  
    else:
...
def load_llff_data(basedir, start_frame, end_frame, 
                   ...
                   ndc_depth=False, final_height=288):
    
    poses, bds, imgs, disp, masks, motion_coords = _load_data(basedir, start_frame, end_frame,
                                                              height=final_height, 
                                                              ndc_depth=ndc_depth) # factor=8 downsamples original imgs by 8x
