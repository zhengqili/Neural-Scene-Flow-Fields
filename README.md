...
(1) The pretraind model is in "nsff_exp/logs/kid-running_ndc_5f_sv_of_sm_unify3_F00-30/". Set datadir in config/config_kid-running.txt to the root directory of input video.
